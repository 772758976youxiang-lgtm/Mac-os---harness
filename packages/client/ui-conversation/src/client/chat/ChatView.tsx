...
import type { ChatViewSlotProps, RenderAvatar, RenderMessageImages } from '../contract/slots.ts'
...
export function ChatView({
  ...
  const renderAvatar = useCallback<RenderAvatar>(
    (side, size) => renderSlot('conversation.avatar', { side, ...size === undefined ? {} : { size } }),
    [renderSlot],
  )
