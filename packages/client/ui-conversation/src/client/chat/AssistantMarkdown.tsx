...
export interface AssistantMarkdownProps {
  ...
  /** Render the agent's avatar disc beside the narration. */
...
export const AssistantMarkdown = memo(function AssistantMarkdown({
  blocks, streaming, interrupted, renderMessageImages, renderAvatar, mentions, t,
  ...
  return (
    <div className={css.root} data-streaming={streaming || undefined}>
      <div className={css.avatarSeat}>{renderAvatar()}</div>
